...
- Avg weekly hours (last 4 weeks): ${ctx.avgWeeklyHours.toFixed(1)} hrs/week
...
9. Only after confirmation, call saveGoals with:
   - summary: a single plain English sentence, e.g. "To hit $110k this year you need 22 sessions/week (18.3 hrs/week) at $96 average payout."
   - reasoning: the full breakdown you presented before confirmation
   - target_weekly_hours: the hours value (sessions × avg_session_duration ÷ 60)
   - avg_weekly_hours_at_time: snapshot the avgWeeklyHours context value above
   - ytd_revenue_at_time, avg_payout_at_time, weeks_remaining_at_input: snapshot the context values above
    ...
    tools: {
      saveGoals: tool({
        ...
        inputSchema: z.object({
          ...
          summary: z.string().describe("One plain English sentence summarizing the recommendation, e.g. 'To hit $110k this year you need 22 sessions/week (18.3 hrs/week) at $96 average payout.'"),

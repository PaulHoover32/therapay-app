...
export const Thread: FC<{ greeting?: string; onFile?: (file: File) => void }> = ({ greeting, onFile }) => {
  return (
      ...
      >
        <div className="mx-auto flex w-full max-w-(--thread-max-width) flex-1 flex-col px-4 pt-4">
          <AuiIf condition={(s) => s.thread.isEmpty}>
            <ThreadWelcome greeting={greeting} />
          </AuiIf>
...
const Composer: FC<{ onFile?: (file: File) => void }> = ({ onFile }) => {
    ...
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
      <ComposerPrimitive.AttachmentDropzone asChild>
        ...
        >
          ...
          />
          <ComposerAction onFile={onFile} fileInputRef={fileInputRef} />
        </div>
...
const ComposerAction: FC<{ onFile?: (file: File) => void; fileInputRef?: React.RefObject<HTMLInputElement | null> }> = ({ onFile, fileInputRef }) => {
  return (
